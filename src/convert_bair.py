...
LastEditTime: 2020-11-11 14:58:15
LastEditors: bg
Description: .tfrecords file dataset processed.
FilePath: /Chelsea-Finn-2016-video-prediction-model/src/convert_bair.py
'''
...
#python src/C.FinnByLin/data/convert_bair.py --data_dir ~/zcl_ws/data/push_dataset/
